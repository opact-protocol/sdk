...
describe('Transfer tests', function test() {
  this.timeout(120000);
  ...
  it('Should create a valid solution batch to transfer an token', async () => {
  ...
  it('Should create a valid solution batch to transfer an NFT', async () => {
